...
select public.reserve_ai_usage('32000000-0000-4000-a000-000000000001','32000000-0000-4000-d000-000000000001',repeat('b',64));
select public.finalize_ai_usage('32000000-0000-4000-a000-000000000001','32000000-0000-4000-d000-000000000001',p_feedback=>'{"schemaVersion":1}',p_attempt=>'32000000-0000-4000-c000-000000000001',p_input=>100,p_output=>20,p_cached=>10,p_thought=>5);
do $$
...
select public.reserve_ai_usage('32000000-0000-4000-a000-000000000001','32000000-0000-4000-d000-000000000002',repeat('b',64));
select public.finalize_ai_usage('32000000-0000-4000-a000-000000000001','32000000-0000-4000-d000-000000000002',p_feedback=>'{"schemaVersion":1}',p_input=>100,p_output=>20);
do $$ begin
