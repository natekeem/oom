...
6. **실전 연습 (`/practice/`)**: 목표 구간·코스 맞춤 랜덤 질문, Level별 권장 시간(1구간 60~90초 / 2구간 45~65초 / 3구간 30~45초) 자동 적용, 답변 시작 시 녹음+타이머 동시 시작, 녹음 종료 후 optional STT 자동 전사, transcript 확인·수정, Course × Level 기반 AI 피드백, 같은 질문 다시 말하기(재도전)를 사용합니다.
