    ...
    variants: [
      {
        ...
        label: "좋아하는 문화 활동",
        questionType: "취미 묘사",
        question: { en: "Tell me about a cultural activity you enjoy, such as watching movies or going to performances.", ko: "영화 관람이나 공연처럼 즐기는 문화 활동을 말해 주세요." },
      ...
      },
      {
        ...
        label: "최근 문화 경험",
        questionType: "최근 경험",
        question: { en: "Describe a memorable movie or performance you attended recently.", ko: "최근 관람한 기억에 남는 영화나 공연을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "음악 감상 루틴",
        questionType: "일상 루틴",
        question: { en: "What kind of music do you like, and when do you usually listen to it?", ko: "어떤 음악을 좋아하고 보통 언제 듣나요?" },
      ...
      },
      {
        ...
        label: "문화생활의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your preference in movies or performances changed over time?", ko: "영화나 공연 취향이 시간에 따라 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "쇼핑 습관과 장소",
        questionType: "장소·루틴",
        question: { en: "Where do you usually go shopping, and what do you like about that place?", ko: "보통 어디로 쇼핑을 가고 그 장소의 어떤 점을 좋아하나요?" },
      ...
      },
      {
        ...
        label: "최근 구매 경험",
        questionType: "최근 경험",
        question: { en: "Tell me about something you bought recently. Why did you buy it?", ko: "최근 구입한 물건을 말해 주세요. 왜 샀나요?" },
      ...
      },
      {
        ...
        label: "두 제품 비교",
        questionType: "비교 / 특징",
        question: { en: "Describe a time when you had to compare two different products before buying.", ko: "구매 전에 두 제품을 비교해야 했던 경험을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "소비 습관의 변화",
        questionType: "과거와 현재",
        question: { en: "How have your shopping habits changed compared to the past?", ko: "과거와 비교해 쇼핑 습관이 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "자주 가는 공원",
        questionType: "장소 묘사",
        question: { en: "Tell me about a park you often go to. What does it look like?", ko: "자주 가는 공원을 말해 주세요. 어떻게 생겼나요?" },
      ...
      },
      {
        ...
        label: "가벼운 운동 루틴",
        questionType: "일상 루틴",
        question: { en: "What kind of light exercise or workout routine do you follow regularly?", ko: "어떤 가벼운 운동 루틴을 꾸준히 하나요?" },
      ...
      },
      {
        ...
        label: "최근 산책 경험",
        questionType: "최근 경험",
        question: { en: "Describe a recent time you went for a walk or jog in a park.", ko: "최근 공원에서 걷거나 조깅했던 경험을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "운동 방식의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your attitude toward exercise changed over time?", ko: "운동에 대한 생각이 시간에 따라 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "집에서 보내는 휴가",
        questionType: "일상 루틴",
        question: { en: "What do you usually do when you take a vacation at home?", ko: "집에서 휴가를 보낼 때 보통 무엇을 하나요?" },
      ...
      },
      {
        ...
        label: "최근 당일치기 여행",
        questionType: "최근 경험",
        question: { en: "Describe a memorable domestic trip or day trip you took recently.", ko: "최근 다녀온 기억에 남는 국내 여행이나 당일치기 여행을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "혼자 사는 집 묘사",
        questionType: "장소 묘사",
        question: { en: "Describe your home. What is your favorite area inside?", ko: "집을 묘사해 주세요. 집 안에서 가장 좋아하는 공간은 어디인가요?" },
      ...
      },
      {
        ...
        label: "휴가관의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your idea of a good vacation changed compared to the past?", ko: "좋은 휴가에 대한 생각이 과거와 비교해 어떻게 달라졌나요?" },
