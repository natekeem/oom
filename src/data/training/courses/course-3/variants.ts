    ...
    variants: [
      {
        ...
        label: "자주 가는 공원",
        questionType: "장소 묘사",
        question: { en: "Tell me about a park or hiking trail you frequently visit. What makes it special?", ko: "자주 가는 공원이나 하이킹 코스를 말해 주세요. 무엇이 특별한가요?" },
      ...
      },
      {
        ...
        label: "주말 걷기·하이킹 루틴",
        questionType: "일상 루틴",
        question: { en: "What is your typical routine when you go walking or hiking on weekends?", ko: "주말에 걷거나 하이킹할 때 보통 어떤 순서로 활동하나요?" },
      ...
      },
      {
        ...
        label: "사진을 찍은 최근 경험",
        questionType: "최근 경험",
        question: { en: "Describe a recent experience when you took interesting photos outdoors.", ko: "최근 야외에서 흥미로운 사진을 찍었던 경험을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "취미 태도의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your perspective on walking or photography changed over time?", ko: "걷기나 사진에 대한 생각이 시간에 따라 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "기억에 남는 캠핑 여행",
        questionType: "최근 경험",
        question: { en: "Tell me about a memorable camping or outdoor trip you took recently.", ko: "최근 다녀온 기억에 남는 캠핑이나 야외 여행을 말해 주세요." },
      ...
      },
      {
        ...
        question: { en: "Describe an unexpected problem you experienced during a trip and how you handled it.", ko: "여행 중 겪은 예상 밖의 문제와 대처 방법을 묘사해 주세요." },
      ...
      },
      {
        ...
        question: { en: "Describe the drive to your coastal campsite.", ko: "해안 캠핑장까지 운전해 간 여정을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "여행관의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your approach to traveling or outdoor trips changed over the years?", ko: "여행이나 야외 여행을 대하는 방식이 지난 몇 년 동안 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "좋아하는 박물관",
        questionType: "장소 묘사",
        question: { en: "Tell me about a museum or art gallery you like to visit.", ko: "즐겨 찾는 박물관이나 미술관을 말해 주세요." },
      ...
      },
      {
        ...
        label: "최근 관람한 전시",
        questionType: "최근 경험",
        question: { en: "Describe a recent exhibition or cultural event you attended.", ko: "최근 관람한 전시나 문화 행사를 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "전시 후 도록 읽기",
        questionType: "최근 경험",
        question: { en: "What did you read after visiting the photography exhibition?", ko: "사진 전시를 본 뒤 무엇을 읽었나요?" },
      ...
      },
      {
        ...
        label: "관점의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your appreciation for art or photography changed over time?", ko: "예술이나 사진을 감상하는 방식이 시간에 따라 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        label: "룸메이트와 사는 집",
        questionType: "장소 묘사",
        question: { en: "Describe the home you live in with your roommate. How is the space shared?", ko: "룸메이트와 함께 사는 집을 묘사해 주세요. 공간을 어떻게 나누어 쓰나요?" },
      ...
      },
      {
        ...
        label: "집에서 보낸 연휴",
        questionType: "일상 루틴",
        question: { en: "What do you usually do when you spend a holiday or long weekend at home?", ko: "휴일이나 긴 주말을 집에서 보낼 때 보통 무엇을 하나요?" },
      ...
      },
      {
        ...
        label: "지난 해외여행의 회상",
        questionType: "과거 경험",
        question: { en: "Tell me about a memorable overseas trip you took in the past.", ko: "과거에 다녀온 기억에 남는 해외여행을 말해 주세요." },
      ...
      },
      {
        ...
        label: "선호하는 휴가 방식",
        questionType: "과거와 현재",
        question: { en: "How have your preferences for holidays changed compared to the past?", ko: "과거와 비교해 선호하는 휴가 방식이 어떻게 달라졌나요?" },
