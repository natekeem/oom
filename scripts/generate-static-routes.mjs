...
const pageGuides = {
  ...
  "/practice/": { purpose: "실전 연습 페이지는 시험 화면 콘솔, 레벨별 목표 시간, 녹음, optional STT 전사, AI 피드백, 재도전으로 구성된 2단계 말하기 훈련 공간입니다.", how: "질문을 뽑은 뒤 Play 버튼으로 질문을 듣고(최대 2회), '답변 시작'을 눌러 녹음합니다. 녹음 완료 후 내 녹음을 듣고, STT transcript를 확인·수정한 뒤 AI 피드백을 받고 같은 질문을 다시 말합니다.", benefit: "시험장과 유사한 조작 환경에서 발화하고, STT와 AI 맞춤 코칭을 통해 즉각적인 개선 포인트를 파악해 다음 시도에 바로 적용할 수 있습니다.", checklist: ["질문을 듣고 핵심 시제와 명사를 잡았다", "OOM 연습 목표 시간에 맞춰 녹음했다", "transcript를 확인·수정했다", "AI 피드백 미션을 반영해 다시 말했다"], mistakes: ["녹음 후 모든 문법을 한 번에 고치려 한다", "STT 미설정 시 직접 입력이 가능한데 포기한다"], links: [["/training/scripts/", "스크립트 훈련"], ["/roleplay/formula/", "롤플레이 공식"], ["/exam-guide/screen/", "시험 화면 가이드"]] },
};
