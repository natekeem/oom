    ...
    variants: [
      {
        ...
        label: "좋아하는 장소",
        questionType: "장소 묘사",
        question: { en: "Tell me about a beach destination you enjoyed visiting.", ko: "즐겁게 방문했던 바닷가 여행지를 말해 주세요." },
      ...
      },
      {
        ...
        question: { en: "Describe a memorable trip you took recently.", ko: "최근 다녀온 기억에 남는 여행을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "여행지에서 한 활동",
        questionType: "활동 순서",
        question: { en: "What did you do during your family trip near the beach?", ko: "바닷가 근처로 가족 여행을 갔을 때 무엇을 했나요?" },
      ...
      },
      {
        ...
        label: "여행 방식의 변화",
        questionType: "과거와 현재",
        question: { en: "How has your travel style changed over time?", ko: "시간이 지나면서 여행 방식이 어떻게 달라졌나요?" },
    ...
    variants: [
      {
        ...
        question: { en: "Tell me about a cafe you often visit.", ko: "자주 방문하는 카페를 말해 주세요." },
      ...
      },
      {
        ...
        label: "집에서 쉬는 루틴",
        questionType: "일상 루틴",
        question: { en: "What do you usually do when you stay at home?", ko: "집에 있을 때 보통 무엇을 하나요?" },
      ...
      },
      {
        ...
        label: "음악을 들은 최근 경험",
        questionType: "최근 경험",
        question: { en: "Describe a recent time you enjoyed listening to music.", ko: "최근 음악을 즐겁게 들었던 경험을 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "바쁜 주 뒤 휴식",
        questionType: "습관 / 이유",
        question: { en: "How do you relax after a busy week?", ko: "바쁜 한 주가 끝난 뒤 어떻게 쉬나요?" },
    ...
    variants: [
      {
        ...
        label: "좋아하는 운동",
        questionType: "취미 묘사",
        question: { en: "Tell me about a sport you enjoy.", ko: "즐기는 운동을 말해 주세요." },
      ...
      },
      {
        ...
        label: "시작 계기",
        questionType: "과거 경험",
        question: { en: "Describe how you started your favorite hobby.", ko: "좋아하는 취미를 어떻게 시작했는지 묘사해 주세요." },
      ...
      },
      {
        ...
        label: "취미 장비 쇼핑",
        questionType: "구매 경험",
        question: { en: "Tell me about something you bought for your hobby.", ko: "취미를 위해 구입한 물건을 말해 주세요." },
      ...
      },
      {
        ...
        label: "실력 향상",
        questionType: "변화 / 비교",
        question: { en: "How have you improved at this activity?", ko: "이 활동의 실력이 어떻게 향상되었나요?" },
    ...
    variants: [
      {
        ...
        label: "내가 사는 집",
        questionType: "장소 묘사",
        question: { en: "Describe the home you live in. What does it look like?", ko: "살고 있는 집을 묘사해 주세요. 어떻게 생겼나요?" },
      ...
      },
      {
        ...
        label: "동네와 편의시설",
        questionType: "주변 환경",
        question: { en: "Tell me about the neighborhood where you live.", ko: "살고 있는 동네를 말해 주세요." },
      ...
      },
      {
        ...
        label: "집안일 분담",
        questionType: "일상 루틴",
        question: { en: "What chores do you usually do at home?", ko: "집에서 보통 어떤 집안일을 하나요?" },
      ...
      },
      {
        ...
        label: "집안일 일정 변경",
        questionType: "문제 해결",
        question: { en: "Describe a problem you had at home and how you solved it.", ko: "집에서 겪은 문제와 그것을 어떻게 해결했는지 묘사해 주세요." },
