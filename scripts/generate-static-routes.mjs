...
const baseRoutes = [
  {
    ...
    description: "적은 수의 기본 스크립트를 익히고 질문에 맞게 필요한 부분만 바꿔 답하며, 녹음·AI 피드백·재도전까지 연습하는 OPIc 훈련 도구입니다.",
    heading: "OPIc, ON ME.",
    content: ["외울 건 줄이고, 바꿔 말할 건 정해두고.", "오픽온미는 적은 수의 기본 스크립트를 익힌 뒤 질문에 맞게 필요한 부분만 바꿔 답하는 브라우저 기반 OPIc 훈련 도구입니다."],
    lastmod: "2026-08-23",
    sections: [
      { heading: "적게 준비하고, 여러 질문에 돌려씁니다.", paragraphs: ["질문마다 새로운 답안을 외우지 않습니다. 같은 장면에서 필요한 fact를 꺼내고 질문의 방향만 바꿉니다."] },
      { heading: "같은 스크립트도 목표에 맞게 밀도를 바꿉니다.", paragraphs: ["Course가 이야기의 맥락을 정하고 Level이 같은 장면의 길이와 답변 밀도를 조절합니다."], bullets: ["3구간 · IM2 / IM1 · 30~45초", "2구간 · IH / IM3 · 45~65초", "1구간 · AL · 60~90초"] },
      { heading: "SIX STEPS. ONE VOICE.", paragraphs: ["목표·코스, 추천 서베이, 난이도, 만능 스크립트, 롤플레이, 실전 연습의 6 STEP을 하나의 목소리로 연결합니다."] },
      { heading: "질문이 틀어져도 처음부터 다시 외우지 않습니다.", paragraphs: ["STEP 4에서는 기본 질문이 변형 질문으로 바뀔 때 같은 story의 fact를 KEEP, CHANGE, REQUIRED, DROP으로 구분합니다."] },
      { heading: "말하고, 확인하고, 한 번만 고쳐 다시 말합니다.", paragraphs: ["질문을 듣고 답한 뒤 내 녹음과 transcript를 확인하고 AI 피드백의 KEEP / FIX / RETRY를 적용해 같은 질문에 다시 답합니다."] },
      { heading: "AI COACH", paragraphs: ["Transcript를 기준으로 답변을 분석하고 유지할 것, 고칠 것, 다음 재시도 미션을 정리합니다.", "AI 피드백은 공식 OPIc 점수·등급 판정이 아닙니다."], links: [{ href: "/about/", label: "오픽온미란?" }, { href: "/training/", label: "실전 훈련 둘러보기" }, { href: "/exam-guide/", label: "OPIc 수험 가이드" }, { href: "/magazine/", label: "OOM Magazine" }] },
      { heading: "PREP LESS. PRACTICE MORE.", paragraphs: ["외울 건 줄이고 실전은 더 많이. 기본 스크립트를 익히고 질문에 맞게 바꾸고 직접 말해보세요."] },
    ],
  },
  {
    path: "/exam-guide/",
  ...
  },
  {
    ...
    title: "OPIc 시험 화면 · 조작법 | 오픽온미",
    description: "OPIc 실제 시험 화면 구성과 인터뷰어, 질문 청취, 녹음 상태, 다음 문제 이동 흐름을 안내합니다.",
    heading: "OPIc 시험 화면 · 조작법",
    content: [
      "가상 인터뷰어(EVA), 질문 청취(최대 2회), 마이크 녹음 상태와 답변 완료 이동 흐름을 도식으로 익힙니다.",
      "OOM 실전 훈련과 동일한 조작 인터페이스를 통해 시험장에서 당황하지 않고 안정적으로 답변할 수 있도록 돕습니다."
    ],
  },
  {
  ...
  },
  {
    ...
    description: "목표 구간 설정부터 서베이 익히기, 스크립트, 롤플레이, 실전 녹음까지 OPIc 말하기 훈련 6단계를 제공합니다.",
    heading: "OPIc 실전 훈련 6 STEP",
    content: ["오픽온미의 훈련 흐름은 STEP 1 목표 구간·코스 설정, STEP 2 추천 서베이 익히기, STEP 3 난이도 설정, STEP 4 만능 스크립트, STEP 5 롤플레이 공식, STEP 6 실전 연습으로 이어집니다.", "답변을 통째로 암기하기보다 하나의 장면을 여러 질문에 맞게 변형하는 연습을 목표로 합니다."],
  },
  {
    path: "/training/setup/",
  ...
  },
  {
    ...
    title: "OPIc 추천 서베이 익히기 | 오픽온미",
    description: "OPIc Background Survey를 참고한 연습용 추천 조합을 직접 골라보며 시험 전에 익숙해지는 단계입니다.",
    heading: "STEP 2. 추천 서베이 익히기",
    content: ["OPIc Background Survey의 일반적인 진행 순서를 참고해 만든 연습용 추천 선택본입니다.", "선택한 코스의 핵심 스토리를 반복 활용할 수 있도록 시험에서 사용할 서베이 조합에 익숙해집니다."],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "선택한 구간의 30~45초, 45~65초, 60~90초 연습 프리셋에 맞춰 같은 장면을 질문 유형별로 바꿔 말합니다.",
      "선택한 코스의 4개 핵심 이야기를 시작·서론, 핵심 장면·본론, 마무리·결론의 3단 말하기 순서로 익힙니다. 실제 문단 수 규칙이 아니며, 각 구간 안에서 ANSWER, SCENE/ACTION, RESULT fact를 골라 질문에 맞춥니다."
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      "롤플레이는 문제·목적, 질문 또는 요청, 다음 행동을 CORE로 먼저 잡고 필요한 정보 질문, 대안, 마무리를 OPTIONAL 메뉴처럼 선택합니다.",
      "선택한 코스에 맞춘 실전 상황별 시나리오를 제공합니다.",
      "6단계를 매번 모두 쓰기보다 상황에 필요한 기능만 골라 문제 해결형 답변을 완성하도록 훈련합니다."
    ],
  },
  {
...
const pageGuides = {
  "/": { purpose: "오픽온미는 OPIc 말하기를 준비하는 학습자가 서베이 선택, 난이도 설정, 스크립트 훈련, 롤플레이, 녹음 복습을 한 흐름으로 이어 가도록 만든 연습용 도구입니다.", how: "처음에는 훈련 허브에서 STEP 1부터 STEP 6까지 순서대로 이동하고, 이후에는 부족한 단계만 반복합니다. 한 번에 많은 주제를 외우기보다 하나의 장면을 여러 질문에 맞게 바꾸는 방식으로 사용하세요.", benefit: "학습자는 답변 범위를 좁히고, 같은 경험을 묘사·비교·문제 해결 질문으로 확장하는 감각을 얻을 수 있습니다.", checklist: ["서베이 선택을 고정했다", "선택한 구간의 목표 시간으로 장면 하나를 말했다", "녹음 후 KEEP/FIX/RETRY 한 가지를 확인했다"], links: [["/training/", "실전 훈련 둘러보기"], ["/training/setup/", "STEP 1 시작"], ["/exam-guide/", "OPIc 수험 가이드"]] },
  "/exam-guide/": { purpose: "OPIc 수험 가이드는 시험의 기본 구조부터 신청, 시험 당일 준비, 성적 확인까지 처음 응시하는 학습자가 확인할 내용을 순서대로 정리한 허브입니다.", how: "소개·등급에서 평가 방식을 이해한 뒤 시험 화면·조작법, 신청·응시료, 신분증·입실, 성적·인증서 순서로 확인합니다. 날짜와 비용처럼 바뀔 수 있는 정보는 각 페이지의 공식 링크에서 응시 직전에 다시 확인합니다.", benefit: "학습 정보와 시험 운영 정보를 구분해 준비 누락을 줄이고, 공식 확인이 필요한 항목을 빠르게 찾을 수 있습니다.", checklist: ["시험 구조와 등급 체계를 확인했다", "시험 화면과 조작법을 확인했다", "접수 상태와 응시료를 공식 화면에서 확인했다", "규정 신분증과 입실 시간을 확인했다", "성적 발표와 인증서 사용 일정을 확인했다"], mistakes: ["학습 예시를 공식 규정으로 오해한다", "오래된 후기만 보고 응시료나 신분증을 결정한다"], links: [["/exam-guide/overview/", "OPIc 소개·등급"], ["/exam-guide/screen/", "시험 화면·조작법"], ["/exam-guide/apply/", "신청·응시료"], ["/exam-guide/day/", "시험 당일"], ["/exam-guide/results/", "성적·인증서"], ["/exam-guide/faq/", "자주 묻는 질문"]] },
  "/exam-guide/overview/": { purpose: "OPIc 소개·등급 페이지는 컴퓨터 기반 말하기 평가의 흐름과 Novice, Intermediate, Advanced 등급대에서 연습할 발화 기준을 설명합니다.", how: "등급 이름만 외우지 말고 질문에 직접 답하는지, 시간·장소·행동·이유를 이어 말하는지, 예상 밖 상황을 설명하고 해결하는지를 기준으로 현재 답변을 확인합니다.", benefit: "어려운 단어 수보다 답변의 구체성, 시간 흐름, 연결과 회복 능력을 중심으로 연습 목표를 세울 수 있습니다.", example: "I usually go to a small park on Sunday mornings because it helps me slow down after a busy week.처럼 장소, 시간, 행동과 이유를 한 장면으로 연결합니다.", checklist: ["목표 등급의 발화 초점을 확인했다", "45초와 90초 답변을 각각 녹음했다", "공식 숙련도 자료 링크를 확인했다"], links: [["/exam-guide/screen/", "시험 화면·조작법"], ["/training/difficulty/", "난이도 설정"], ["/magazine/opic-grade-guide/", "등급별 답변 차이 읽기"], ["/exam-guide/apply/", "신청 안내로 이동"]] },
  "/exam-guide/screen/": { purpose: "시험 화면·조작법 페이지는 실제 OPIc 평가 인터페이스와 유사한 도식을 통해 인터뷰어, 청취, 녹음, 다음 문항 이동 흐름을 미리 익히도록 돕습니다.", how: "인터뷰어 영역, 질문 Play 버튼, 0/2 청취 횟수, 마이크 녹음 상태, 답변 완료 이동 흐름을 순서대로 확인하고 STEP 6 실전 연습으로 직접 이동합니다.", benefit: "시험장에 가서 처음 마주하는 화면 구조에 당황하지 않고 질문 청취와 답변 시작 타이밍을 침착하게 가져갈 수 있습니다.", checklist: ["질문 청취 횟수(최대 2회)를 확인했다", "마이크 녹음 상태 표시를 확인했다", "OOM 타이머가 실제 제한시간이 아님을 확인했다"], links: [["/practice/", "STEP 6 실전 연습"], ["/exam-guide/overview/", "소개·등급"], ["/exam-guide/day/", "시험 당일 준비"]] },
  ...
  "/roleplay/": { purpose: "롤플레이 허브는 6단계 기능 메뉴와 코스별 실전 시나리오를 연습하는 공간입니다.", how: "먼저 문제·목적, 질문 또는 요청, 다음 행동을 말하고 상황에 따라 정보 질문, 대안, 마무리를 선택합니다. 6단계를 매번 모두 사용할 필요는 없습니다.", benefit: "돌발 상황에서도 필요한 기능을 골라 문제 해결 흐름을 이어갈 수 있습니다.", checklist: ["CORE 세 기능을 확인했다", "코스 시나리오를 직접 말했다", "필요한 OPTIONAL 기능만 골랐다"], links: [["/roleplay/formula/", "롤플레이 공식"], ["/practice/", "실전 연습"]] },
