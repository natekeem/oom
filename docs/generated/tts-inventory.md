...
- Baseline HEAD: `b75fa4c329cc1c7a91b17030fcf5451dc7451249`
- Baseline origin/main: `b75fa4c329cc1c7a91b17030fcf5451dc7451249`
- Current Kokoro consumers: STEP 3 fixed previews, STEP 4 canonical `englishScript`, STEP 6 fixed `question.prompt`.
- Current playable inventory: **146 logical / 146 unique texts; 100% build-time enumerable**.
- Expanded static-first candidate inventory, including resolved STEP 4 variants and STEP 5 prompts: **317 logical / 287 globally unique texts**.
- Global duplicate saving: **30 items (9.5%)**.
- Four voices require **1,148 Opus files** for the expanded inventory.
- Four-voice Opus 64 kbps estimate: **240.82 MB — GREEN**.
...
| Global deduped total | 317 | 287 | 125.43 min | 1,148 | 180.61 MB | 240.82 MB |
...
Expanded four-voice WAV estimate: **1.44 GB**. Current playable-only four-voice estimates are **447.97 MB WAV**, **56 MB Opus 48k**, and **74.66 MB Opus 64k** across **584 files**.
...
| --- | --- | --- | --- | --- | --- | --- |
| course-1 | advanced | 4 | 16 | 12 | 3 | 33 |
| course-1 | intermediate | 4 | 16 | 12 | 3 | 33 |
| course-1 | foundation | 4 | 16 | 12 | 3 | 33 |
| course-2 | advanced | 4 | 16 | 12 | 3 | 34 |
| course-2 | intermediate | 4 | 16 | 12 | 3 | 34 |
| course-2 | foundation | 4 | 16 | 12 | 3 | 34 |
| course-3 | advanced | 4 | 16 | 12 | 3 | 34 |
| course-3 | intermediate | 4 | 16 | 12 | 3 | 34 |
| course-3 | foundation | 4 | 16 | 12 | 3 | 34 |
...
- Expanded unique single-voice audio duration: **125.43 minutes**.
- Expanded four-voice playback duration: **501.71 minutes**.
- Four-voice storage: **1.44 GB WAV**, **180.61 MB Opus 48k**, **240.82 MB Opus 64k**.
- Existing-course average: **95.0 unique texts / 380 files / 41.76 single-voice minutes / 80.18 MB Opus 64k per similarly shaped course**.
...
Build-time peaks are feasible and let WaveSurfer render the real waveform before audio download/decoding. Store `duration` and 200–400 normalized peaks per voice/audio asset. At roughly 2–3 KB of JSON per 300-value array, 1,148 assets imply approximately **2.3–3.44 MB** before compression.
...
3. Pre-generate the **current playable set first**: 146 texts × 4 voices = 584 audio files, including the current eight preview combinations.
